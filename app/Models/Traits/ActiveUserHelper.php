...
trait ActiveUserHelper
{
    ...
    protected int $pass_days = 365;    // 多少天内发表过内容
    protected int $user_number = 6; // 取出来多少用户

    // cache config
    protected string $cache_key = 'bbs_active_users';
    protected int|float $cache_expire_in_seconds = 65 * 60;
